...
#define __LCD_H
    ...
    */
    ...
    /*** 控制线 ***/
    /* 片选 */
    #define LCD_CS_H    GPIO_SetBits(GPIOG,GPIO_Pin_12)       /* 片选失能 */
    #define LCD_CS_L    GPIO_ResetBits(GPIOG,GPIO_Pin_12)     /* 片选使能 */
    /* 写使能 */
    #define LCD_WR_H    GPIO_SetBits(GPIOD,GPIO_Pin_5)        /* 写失能 */
    #define LCD_WR_L    GPIO_ResetBits(GPIOD,GPIO_Pin_5)      /* 写使能 */
    /* 读使能 */
    #define LCD_RD_H    GPIO_SetBits(GPIOD,GPIO_Pin_4)        /* 读失能 */
    #define LCD_RD_L    GPIO_ResetBits(GPIOD,GPIO_Pin_4)      /* 读使能 */
    /* 数据命令选择线 */
    #define LCD_DC_H    GPIO_SetBits(GPIOF,GPIO_Pin_12)       /* 收发数据 */
    #define LCD_DC_L    GPIO_ResetBits(GPIOF,GPIO_Pin_12)     /* 收发命令 */
    /* 背光 */
    #define LCD_BL_H    GPIO_SetBits(GPIOB,GPIO_Pin_15)       /* 开启背光 */
    #define LCD_BL_L    GPIO_ResetBits(GPIOB,GPIO_Pin_15)     /* 关闭背光 */
