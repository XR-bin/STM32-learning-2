...
/*************************** FSMC 驱 动 LCD ******************************/
  ...
  typedef struct
  {                      //基础地址      0x6c00 0000
    vu16 TFTLCD_CMD;     //命令数据地址  0x6c00 07ee   地址偏移0x00
    vu16 TFTLCD_DAT;     //参数数据地址  0x6c00 0800   地址偏移0x02
  }TFTLCD_TypeDef;
...
*********************************************************************/
  //定义方法1(宏定义方法)
  #define  TFTLCD_CMD1     (*(vu16 *)((u32)0x6c000000))
  #define  TFTLCD_DAT1     (*(vu16 *)((u32)0x6c000800))
...
*********************************************************************/
  //定义方法2(结构体方法)
  #define TFTLCD_BASE  ((u32)0x6c0007fe)   //基础地址
