...
#define __LCD_H
    ...
    /* 数据命令选择线 */
    #define LCD_DC_H    GPIO_SetBits(GPIOG,GPIO_Pin_0)       /* 收发数据 */
    #define LCD_DC_L    GPIO_ResetBits(GPIOG,GPIO_Pin_0)     /* 收发命令 */
    /* 背光 */
    #define LCD_BL_H    GPIO_SetBits(GPIOB,GPIO_Pin_0)       /* 开启背光 */
    #define LCD_BL_L    GPIO_ResetBits(GPIOB,GPIO_Pin_0)     /* 关闭背光 */
